...
[Service]
ExecStart=$SRB_BINARY --multi-algorithm-job-mode 3 --disable-gpu --algorithm randomepic --algorithm randomx --pool sg.epicmine.io:3333 --pool xtm-rx.kryptex.network:7038 --wallet 0x6810d21581c27.Worker01 --wallet 12JumnBTSpc1g6yxLTYPDbhxoUeB3JAf91MyTsEf1YjyGrwp4LAed4Sa6KMBfwKBKbpZz9s5fBHtogNK9oJMbNy9DhX/Worker03 --password Worker01 --password Worker03 --keepalive true --keepalive true --nicehash false --nicehash true
Restart=always
RestartSec=5
RuntimeMaxSec=5d
