...
[Service]
ExecStart=$SRB_BINARY --multi-algorithm-job-mode 1 --disable-cpu --algorithm progpow_epic --pool de.epicmine.io:3334 --tls true --wallet 0x6810d21581c27.in --password m=pool --keepalive true
RestartSec=5
RuntimeMaxSec=5d
